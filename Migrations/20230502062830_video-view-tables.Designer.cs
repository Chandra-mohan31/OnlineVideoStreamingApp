...
namespace OnlineVideoStreamingApp.Migrations
{
    ...
    [Migration("20230502062830_video-view-tables")]
    partial class videoviewtables
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OnlineVideoStreamingApp.Models.SavedPostsModelcs", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("OnlineVideoStreamingApp.Models.VideoViewsModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("OnlineVideoStreamingApp.Models.SavedPostsModelcs", b =>
                {
                    b.HasOne("OnlineVideoStreamingApp.Models.VideosModel", "SavedVideo")
                        .WithMany()
                        .HasForeignKey("SavedVideoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("OnlineVideoStreamingApp.Areas.Identity.Data.OnlineVideoStreamingAppUser", "User")
                        .WithMany()
                        .HasForeignKey("UserId");
            ...
            modelBuilder.Entity("OnlineVideoStreamingApp.Models.VideoViewsModel", b =>
                {
                    ...
                    b.HasOne("OnlineVideoStreamingApp.Areas.Identity.Data.OnlineVideoStreamingAppUser", "ViewedUser")
                        .WithMany()
